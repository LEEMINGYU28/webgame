...
document.addEventListener("DOMContentLoaded", function() {
	...
	sentence.innerHTML = "2번방 투숙객은 피해자와 오래된 친구였으며,<br>항상 운동을 같이하는 운동 메이트 였다고 한다.<br><br>단서가 있는지 조사해보자.";
	...
	const tableBtn = document.getElementById("drawerbtn");
	const photoBtn = document.getElementById("chairbtn");
